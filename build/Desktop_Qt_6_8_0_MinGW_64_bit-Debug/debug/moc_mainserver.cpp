...
struct qt_meta_stringdata_CLASSMainServerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMainServerENDCLASS = QtMocHelpers::stringData(
    "MainServer"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMainServerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MainServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMainServerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMainServerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainServerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MainServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMainServerENDCLASS.stringdata0))
